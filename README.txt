to install run python interpreter on this folder and type
setup.py install
...
this is my first project i will correct errors in next time.



PyAIML -- The Python AIML Interpreter
author: Athuldevin (athuldevin@gmail.com)
